...
//                    int computerNumberChoice = getRandomNumber();
                    int computerNumberChoice = 1;
                    Thread.sleep(sleepTime);
                    System.out.println("The computer generated: " + computerNumberChoice);
                    Thread.sleep(sleepTime);
                    if (playerNumberChoice > computerNumberChoice) {
                        System.out.println("Congratulations! You win!\n***********\n");
                        resultList.add("Round #" + (roundCounter + 1) + ": You chose: " + playerNumberChoice + ", the computer chose: " + computerNumberChoice + " ==> You won");
                        ...
                        if (coinFlipUserChoice.equalsIgnoreCase("heads") && coinFlip <= 5) {
                            ...
                            resultList.add("Round #" + (roundCounter + 1) + ": You chose: " + playerNumberChoice + ", the computer chose: " + computerNumberChoice + " ==> Tiebreaker ==> Coin flip: You chose: " + coinFlipUserChoice + ", the coin landed on " + coinFlip + " ==> You won");
    ...
    public static void printTotalResults(List resultList){    /*Finish the round results portion before moving to total results*/
